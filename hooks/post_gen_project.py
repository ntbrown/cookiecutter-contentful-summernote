...
class MockResult(Result):
    mock_stdout = {
        "github.com": """Password for 'https://ntbrown@github.com':
Counting objects: 18, done.
Delta compression using up to 8 threads.
Compressing objects: 100% (15/15), done.
Writing objects: 100% (18/18), 6.24 KiB | 0 bytes/s, done.
Total 18 (delta 0), reused 0 (delta 0)
To https://github.com/ntbrown/cookiecutter-contentful-summernote.git
* [new branch]      master -> master
Branch master set up to track remote branch master from origin.""",
        "gitlab.com": """Password for 'https://ntbrown@gitlab.com':
...
remote:
remote: The private project ntbrown/cookiecutter-contentful-summernote was successfully created.
remote:
remote: To configure the remote, run:
remote:   git remote add origin https://gitlab.com/ntbrown/cookiecutter-contentful-summernote.git
remote:
remote: To view the project, visit:
remote:   https://gitlab.com/ntbrown/cookiecutter-contentful-summernote
remote:
To https://gitlab.com/ntbrown/cookiecutter-contentful-summernote.git
* [new branch]      master -> master
Branch master set up to track remote branch master from origin.""",
        "bitbucket.org": """Password for 'https://ntbrown@bitbucket.org':
Counting objects: 13, done.
Delta compression using up to 8 threads.
Compressing objects: 100% (10/10), done.
Writing objects: 100% (13/13), 5.26 KiB | 0 bytes/s, done.
Total 13 (delta 0), reused 0 (delta 0)
To https://bitbucket.org/ntbrown/cookiecutter-contentful-summernote.git
* [new branch]      master -> master
Branch master set up to track remote branch master from origin.""",
    }
...
class PostGenProjectHook(object):
    ...
    def git_commit(message="Initial commit"):
        ...
        if os.name == "nt":
            # See https://github.com/ntbrown/cookiecutter-git/issues/43
    ...
    def _handle_manifest_resources(self):
        """
        Deletes manifest resources - if necessary.
        """
